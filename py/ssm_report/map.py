...
def make_map_information(output_dir, virus_type, assay, interactive=False, open_image=None, force=False):
    make_map(output_dir=output_dir, prefix=f"{virus_type}-{assay}", virus_type=virus_type, assay=assay, mod="information", interactive=interactive, open_image=open_image, force=force, settings_labs_key="information_labs")
