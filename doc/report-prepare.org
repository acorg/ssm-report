...
*** just re-make seqdb (in case of downloading new sequences or fixing locations)
  ...
  ad seqdb-create --db /d/seqdb.json.xz --match-hidb --clades --report-not-aligned-prefixes 32 --save-not-found-locations /d/not-found.txt ~/ac/tables-store/sequences/*.fas.bz2
...
** run make-signature-pages
  ...
  ad make-signature-pages -t YYYY-MMDD --seqdb ~/AD/data/seqdb.json.xz --tree-maker-speed week
